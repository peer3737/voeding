...
function send_update(){
	...
	url = "send_update.php?prod_id="+product_id+"&amount="+amount+"&date="+date;
	console.log(url);
 var xhr = new XMLHttpRequest();
...
<tr><td style="padding:2px;">Product</td><td style=" display: flex;">
			...
			<tr><td>Grootte eenheid</td><td>
			<span id="size_type"/></td>
			</tr>	
			<tr><td>Laatste waarden (max 10)</td><td>
			<span id="choices"/></td>
			</tr>
			<tr><td>Aantal eenheden</td><td>
			<input type="text" id="amount"/></td>
			</tr>
			<tr><td>Datum</td><td>
			<input type="date" id="date"/></td>
			</tr>
			<tr><td></td><td><button style="width:50vw;" type="button" onclick="send_update()" id="send_update" >Werk totalen bij</button></td></tr>
			</table>
			</center>
        </main>
    </div>
